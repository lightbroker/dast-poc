...
* URL: http://altoro.testfire.net/login.jsp
  * Method: `GET`
  * Parameter: ``
  * Attack: `http://altoro.testfire.net/login.jsp/dpvo2/ex12w`
...
* URL: http://altoro.testfire.net/doLogin
  ...
  * Evidence: ``
  * Other Info: `[cookie] parameter [JSESSIONID] leaks information on whether a user exists. The [2] differences in output, for the valid original username value [416D823370884B05889EB21F3C5AAE23], and invalid username value [slwtznpidsdqnbyygzuvondlkjuqwoko] are:
[
(Changed Text)
...
* URL: http://altoro.testfire.net
  ...
  * Parameter: `JSESSIONID`
  * Attack: ``
  * Evidence: `416D823370884B05889EB21F3C5AAE23`
  * Other Info: `
cookie:JSESSIONID`
* URL: http://altoro.testfire.net/
  * Method: `GET`
  * Parameter: `JSESSIONID`
  * Attack: ``
  * Evidence: `CBD12FFD7F92ECEFD95F3D84904F9DC8`
  * Other Info: `
cookie:JSESSIONID`
* URL: http://altoro.testfire.net/doLogin
  * Method: `POST`
