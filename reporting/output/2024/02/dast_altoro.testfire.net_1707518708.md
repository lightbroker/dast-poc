...
* URL: http://altoro.testfire.net/login.jsp
  * Method: `GET`
  * Parameter: ``
  * Attack: `http://altoro.testfire.net/login.jsp/aae3e/xk31l`
...
* URL: http://altoro.testfire.net/doLogin
  ...
  * Evidence: ``
  * Other Info: `[cookie] parameter [JSESSIONID] leaks information on whether a user exists. The [2] differences in output, for the valid original username value [30DE6604FD1764701A3597672B893BB8], and invalid username value [sibkfyrluuxkfmdzmvzttozvbzdkuowy] are:
[
(Changed Text)
...
* URL: http://altoro.testfire.net
  ...
  * Parameter: `JSESSIONID`
  * Attack: ``
  * Evidence: `30DE6604FD1764701A3597672B893BB8`
  * Other Info: `
cookie:JSESSIONID`
* URL: http://altoro.testfire.net/
  * Method: `GET`
  * Parameter: `JSESSIONID`
  * Attack: ``
  * Evidence: `5B0A94AF85EFB0FF7FAC2977383DFAD2`
  * Other Info: `
cookie:JSESSIONID`
* URL: http://altoro.testfire.net/doLogin
  * Method: `POST`
