...
* URL: http://altoro.testfire.net/login.jsp
  * Method: `GET`
  * Parameter: ``
  * Attack: `http://altoro.testfire.net/login.jsp/b4ekw/9jyk7`
...
* URL: http://altoro.testfire.net/doLogin
  ...
  * Evidence: ``
  * Other Info: `[cookie] parameter [JSESSIONID] leaks information on whether a user exists. The [2] differences in output, for the valid original username value [6B166D611FE3C324686959066ECB67D8], and invalid username value [rokzgshworeiqaizndgrawpmbkwewabo] are:
[
(Changed Text)
...
* URL: http://altoro.testfire.net
  ...
  * Parameter: `JSESSIONID`
  * Attack: ``
  * Evidence: `6B166D611FE3C324686959066ECB67D8`
  * Other Info: `
cookie:JSESSIONID`
* URL: http://altoro.testfire.net/
  * Method: `GET`
  * Parameter: `JSESSIONID`
  * Attack: ``
  * Evidence: `E117D4DC852295F113761E2A093A127B`
  * Other Info: `
cookie:JSESSIONID`
* URL: http://altoro.testfire.net/doLogin
  * Method: `POST`
