...
* URL: http://altoro.testfire.net/login.jsp
  * Method: `GET`
  * Parameter: ``
  * Attack: `http://altoro.testfire.net/login.jsp/wfyq0/84dup`
...
* URL: http://altoro.testfire.net/doLogin
  ...
  * Evidence: ``
  * Other Info: `[cookie] parameter [JSESSIONID] leaks information on whether a user exists. The [2] differences in output, for the valid original username value [1F30F4DE722DD27EF38E937FAF0989EE], and invalid username value [npguobfqmenhpiinjwplfgcmkwscslwk] are:
[
(Changed Text)
...
* URL: http://altoro.testfire.net
  ...
  * Parameter: `JSESSIONID`
  * Attack: ``
  * Evidence: `1F30F4DE722DD27EF38E937FAF0989EE`
  * Other Info: `
cookie:JSESSIONID`
* URL: http://altoro.testfire.net/
  * Method: `GET`
  * Parameter: `JSESSIONID`
  * Attack: ``
  * Evidence: `3372A6ED7614EDF3ACC787D0898D0CFF`
  * Other Info: `
cookie:JSESSIONID`
* URL: http://altoro.testfire.net/doLogin
  * Method: `POST`
