...
* URL: http://altoro.testfire.net/login.jsp
  * Method: `GET`
  * Parameter: ``
  * Attack: `http://altoro.testfire.net/login.jsp/fn3nl/4erja`
...
* URL: http://altoro.testfire.net/doLogin
  ...
  * Evidence: ``
  * Other Info: `[cookie] parameter [JSESSIONID] leaks information on whether a user exists. The [2] differences in output, for the valid original username value [B01720E772D1E70D4ACE7753B9C3B2D3], and invalid username value [endpawkoxtxnhezdhfhxgtgdjbmrvvny] are:
[
(Changed Text)
...
* URL: http://altoro.testfire.net
  ...
  * Parameter: `JSESSIONID`
  * Attack: ``
  * Evidence: `B01720E772D1E70D4ACE7753B9C3B2D3`
  * Other Info: `
cookie:JSESSIONID`
* URL: http://altoro.testfire.net/
  * Method: `GET`
  * Parameter: `JSESSIONID`
  * Attack: ``
  * Evidence: `A1893E6BAAE61EBA808B67DB267C5CA2`
  * Other Info: `
cookie:JSESSIONID`
